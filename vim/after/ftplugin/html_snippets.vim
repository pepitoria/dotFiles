...
exec "Snippet skel5 <!DOCTYPE html><CR><html><CR><head><CR><meta http-equiv=\"Content-type\" content=\"text/html; charset=utf-8\" /><CR><title>".st.et."</title><CR>".st.et."<CR></head><CR><body id=\"".st.et."\" ".st.et."><CR>".st.et."<CR></body><CR></html>"
...
exec "Snippet scriptsrc <script src=\"".st.et."\" type=\"text/javascript\"></script><CR>".st.et
...
exec "Snippet mus {{ ".st.et." }}".st.et
exec "Snippet loren1 Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, At accusam aliquyam diam diam dolore dolores duo eirmod eos erat, et nonumy sed tempor et et invidunt justo labore Stet clita ea et gubergren, kasd magna no rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua."
exec "Snippet loren2 Lorem ipsum dolor sit amet, sumo docendi mei id, paulo intellegam est et. Ad cum agam mollis sanctus. Ei per dicam populo persecuti, ex brute concludaturque qui, id democritum reformidans qui. Pro aliquam legendos postulant eu, quo inciderint reprehendunt ut. Mea ea vocent eruditi recteque, erant senserit evertitur has te. Has id vivendo definiebas concludaturque, at duo nemore mnesarchum. Modo omnes sententiae vim ex, at dicat graeco veritus eum. At sea sonet insolens, habeo elitr ad mea. Vix ne affert recteque, ad eum suas unum. Solet eligendi vis no, singulis praesent per ad. Probatus intellegebat ei pri."

exec "Snippet bstext <!-- ".st."label".et." --><CR><div class=\"form-group row\"><CR><label for=\"".st."name".et."\" class=\"col-sm-2 control-label\">".st."label".et."</label><CR><div class=\"col-sm-10\"><CR><input type=\"input\" class=\"form-control\" id=\"".st."name".et."\" placeholder=\"".st."label".et."\"/><CR></div><CR></div><CR>".st.et
exec "Snippet bstextarea <!-- ".st."label".et." --><CR><div class=\"form-group row\"><CR><label for=\"".st."name".et."\" class=\"col-sm-2 control-label\">".st."label".et."</label><CR><div class=\"col-sm-10\"><CR><textarea class=\"form-control\" id=\"".st."name".et."\" cols=\"".st.et."\"></textarea><CR></div><CR></div><CR>".st.et
exec "Snippet insert :".st."res".et." -> ".st."res".et." ".st.et
